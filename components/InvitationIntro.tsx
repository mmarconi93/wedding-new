...
export default function InvitationIntro() {
  ...
  // Show only on first visit (per device)
  useEffect(() => {
  ...
  return (
    <div
      ...
      // give 3D perspective for the flap rotation
    ...
    >
      ...
      <div className="relative w-80 h-56 sm:w-[28rem] sm:h-44">
        ...
        <div className="absolute inset-0 rounded-xl overflow-hidden">
          {/* left */}
          <div className="absolute left-0 bottom-0 w-1/2 h-1/2 bg-[#123428]" style={{ clipPath: "polygon(0 100%, 100% 100%, 0 0)" }} />
          {/* right */}
          <div className="absolute right-0 bottom-0 w-1/2 h-1/2 bg-[#123428]" style={{ clipPath: "polygon(0 100%, 100% 100%, 100% 0)" }} />
          {/* bottom */}
          <div className="absolute left-0 right-0 bottom-0 h-1/2 bg-[#113125]" style={{ clipPath: "polygon(0 100%, 50% 0, 100% 100%)" }} />
        </div>
